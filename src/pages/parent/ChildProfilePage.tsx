...
import { Mail, Phone, MessageSquare, GraduationCap, Calendar, BookOpen, Heart, MapPin } from "lucide-react";
          ...
          <div className="flex items-end gap-4">
            ...
            <div className="pb-1">
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                ...
                <Badge className="bg-green-500/15 text-green-700 hover:bg-green-500/20">92% Attendance</Badge>
                <Badge className="bg-secondary/30 text-secondary-foreground hover:bg-secondary/40">House: Mbira</Badge>
              </div>
            </div>
          </div>
          <Button className="bg-accent text-accent-foreground hover:bg-accent/90"><MessageSquare className="h-4 w-4" /> Message Class Teacher</Button>
        </div>
      </CardContent>
    </Card>
          ...
          {subjects.map((s) => (
            <div key={s.name}>
              <div className="mb-1.5 flex items-center justify-between gap-3">
                ...
                <Badge className="bg-accent/15 text-accent hover:bg-accent/20">{s.grade}</Badge>
              </div>
