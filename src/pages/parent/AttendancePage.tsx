...
Monthly Trend:
${monthly.map(m => `${m.month}: ${m.rate}%`).join("\n")}`;
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card className="border-none shadow-md">
          ...
          <CardContent className="space-y-2">
            ...
            <div className="pt-2">
              <div className="mb-1 flex justify-between text-xs"><span className="text-muted-foreground">Term progress</span><span className="font-semibold">92%</span></div>
